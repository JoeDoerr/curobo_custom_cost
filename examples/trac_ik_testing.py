...
ind = 1
pos = torch.load(f'/data/local/kc1317/workspace/pos{ind}.pt').squeeze(0)
quat = torch.load(f'/data/local/kc1317/workspace/quat{ind}.pt').squeeze(0)

num_poses = pos.shape[0]
